    ...
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <section className="about">
          <ScrollReveal baseOpacity={0} enableBlur={false} baseRotation={2}>
            <h2 className="aboutText">
              {" "}
              We are an independent film studio based in Madison, WI.
            </h2>
          </ScrollReveal>
          {/* <h2 id="aboutText">
        ...
        <section className="servicesContainer">
          <ScrollVelocity
            texts={["Services ⟡ Services ⟡ Services ⟡ Services ⟡", "Stupid"]}
            velocity={100}
          />
